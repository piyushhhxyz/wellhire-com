          ...
          {teamMembers.map((member, index) => (
            ...
            >
              <img
                src={member.image}
                alt={member.name}
                className="w-48 h-48 rounded-full mx-auto mb-4 border-4 border-purple-500"
              />
              <h3 className="text-2xl font-semibold text-center mb-2 text-gray-900 dark:text-white">
                {member.name}
              </h3>
              <p className="text-purple-600 dark:text-purple-400 text-center mb-2 font-medium">
                {member.role}
              </p>
              <p className="text-gray-600 dark:text-gray-400 text-center mb-4 italic">
                {member.description}
              </p>
