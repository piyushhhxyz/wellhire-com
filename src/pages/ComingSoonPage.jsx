...
const ComingSoonPage = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
      ...
      >
        <h1 className="text-5xl cursor-default font-bold mb-8 bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-pink-600">
          Coming Soon
        </h1>
        <p className="text-xl cursor-default text-gray-700 dark:text-gray-300 mb-12">
